   ...
   <script language="JavaScript">
        $(function () {
            ...
            function showStreet(did) {
                $.post("getStreetByid2",{"did":did},function (data) {
...
<DIV class=box>
<FORM id=add_action method=post   action=/upHouse enctype="multipart/form-data">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD><INPUT class=text value="<f:formatDate value="${house.pubdate}" pattern="yyyy-MM-dd"></f:formatDate>" type=date name=pubdate></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD>
        <img src="http://localhost/${house.path}?a=<%=Math.random()%>" width="100" height="75" alt="">
        <input type="hidden" name="oldPic" value="${house.path}">

        <INPUT id=aaa class=text type=file name="pfile"> </TD></TR>

  <TR>
    <TD class=field>详细信息：</TD>
    <TD><TEXTAREA name=description>${house.description}</TEXTAREA></TD></TR></TBODY></TABLE>
<DIV class=buttons>
    <INPUT  value=确认修改 type=submit id="dd">
